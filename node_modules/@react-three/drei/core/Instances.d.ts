...
export declare function createInstances(): (React.ForwardRefExoticComponent<Omit<InstancesProps, "ref"> & React.RefAttributes<THREE.InstancedMesh<THREE.BufferGeometry, THREE.Material | THREE.Material[]>>> | React.ForwardRefExoticComponent<Omit<InstanceProps, "ref"> & React.RefAttributes<PositionMesh>>)[];
